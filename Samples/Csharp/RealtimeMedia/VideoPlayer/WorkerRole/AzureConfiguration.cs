...
namespace WorkerRole
{
    ...
    internal class AzureConfiguration : IConfiguration
    {
        ...
        private const string AudioContainerKey = "AudioContainer";
        private const string VideoContainerKey = "VideoContainer";
        private const string AudioFileKey = "AudioFile";
        private const string VideoFileKey = "VideoFile";
        private const string StorageConnectionStringKey = "Microsoft.WindowsAzure.Plugins.Diagnostics.ConnectionString";
        ...
        public string AudioContainer { get; private set; }

        public string VideoContainer { get; private set; }
        ...
        public void Initialize()
        {
            ...
            StorageAccountConnection = GetString(StorageConnectionStringKey);
            AudioContainer = GetString(AudioContainerKey);
            VideoContainer = GetString(VideoContainerKey);
            AudioFile = GetString(AudioFileKey);
            VideoFile = GetString(VideoFileKey);
